...
import (
	_type "github.com/mickamy/contest/example/gen/google/type"
...
type Binding struct {
	...
	// [IAM
	// documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
	Condition     *_type.Expr `protobuf:"bytes,3,opt,name=condition,proto3" json:"condition,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Binding) GetCondition() *_type.Expr {
	if x != nil {
		return x.Condition
	}
	return nil
...
type BindingDelta struct {
	...
	// The condition that is associated with this binding.
	Condition     *_type.Expr `protobuf:"bytes,4,opt,name=condition,proto3" json:"condition,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BindingDelta) GetCondition() *_type.Expr {
	if x != nil {
		return x.Condition
	}
	return nil
...
const file_google_iam_v1_policy_proto_rawDesc = "" +
	...
	"\x03ADD\x10\x01\x12\n" +
	"\n" +
	"\x06REMOVE\x10\x02B\xb5\x01\n" +
	"\x11com.google.iam.v1B\vPolicyProtoP\x01Z:github.com/mickamy/contest/example/gen/google/iam/v1;iamv1\xf8\x01\x01\xa2\x02\x03GIX\xaa\x02\rGoogle.Iam.V1\xca\x02\rGoogle\\Iam\\V1\xe2\x02\x19Google\\Iam\\V1\\GPBMetadata\xea\x02\x0fGoogle::Iam::V1b\x06proto3"
...
var file_google_iam_v1_policy_proto_goTypes = []any{
	...
	(*_type.Expr)(nil),           // 10: google.type.Expr
}
