...
import (
	_ "github.com/mickamy/contest/example/gen/google/api"
...
const file_google_iam_v1_iam_policy_proto_rawDesc = "" +
	...
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/{resource=**}:testIamPermissions\x1a\x1e\xcaA\x1biam-meta-api.googleapis.comB\xb5\x01\n" +
	"\x11com.google.iam.v1B\x0eIamPolicyProtoP\x01Z:github.com/mickamy/contest/example/gen/google/iam/v1;iamv1\xa2\x02\x03GIX\xaa\x02\rGoogle.Iam.V1\xca\x02\rGoogle\\Iam\\V1\xe2\x02\x19Google\\Iam\\V1\\GPBMetadata\xea\x02\x0fGoogle::Iam::V1b\x06proto3"
